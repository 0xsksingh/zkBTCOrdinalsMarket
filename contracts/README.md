...
Ordinal4907 Renting Contract Description

Ordinal4907 contract implements the Ordinal4907 interface. It extends the `ERC721Base` contract and adds functionality for managing users and expiration times for NFTs.
